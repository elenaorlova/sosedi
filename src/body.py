...
def main():
    ...
    def region(message):
        ...
        get_reg = ["Академический", "Алексеевский", "Алтуфьевский", "Арбат", "Аэропорт",
                   ...
                   "Дмитровский", "Донской", "Дорогомилово", "Жуковский", "Замоскворечье", "Зеленоград",
                   ...
                   "Кунцево", "Куркино", "Королёв", "Левобережный", "Лефортово", "Лианозово", "Ломоносовский",
                   ...
                   "Останкинский", "Отрадное", "Очаково-матвеевское", "Одинцово", "Перово", "Печатники",
